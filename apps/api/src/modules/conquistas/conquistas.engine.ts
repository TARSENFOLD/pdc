...
// TENTATIVA_CONCLUIDA maps to 'simulacao.concluida' (canonical trigger for simulation-complete conquistas)
...
export const REGRAS: readonly ConquistaRule[] = [
  {
    ...
    descricao: 'Completou a primeira simulação vocacional',
  ...
  },
  {
    ...
    condition: thresholdCondition(DomainEventName.PERFIL_ATUALIZADO, 1),
  },
  {
    ...
    condition: thresholdCondition(DomainEventName.LOGIN, 7),
  },
  {
    slug: 'primeiro-curso',
    ...
    condition: thresholdCondition(DomainEventName.CURSO_PUBLICADO, 1),
  },
  {
    slug: 'simulador-iniciante',
    trigger: DomainEventName.SIMULACAO_CRIADA,
    titulo: 'Simulador Iniciante',
    descricao: 'Criou a primeira simulação vocacional',
    condition: thresholdCondition(DomainEventName.SIMULACAO_CRIADA, 1),
  },
  {
    slug: 'critico-construtivo',
    trigger: DomainEventName.RATING_CRIADO,
    titulo: 'Crítico Construtivo',
    descricao: 'Deu a primeira avaliação na plataforma',
    condition: thresholdCondition(DomainEventName.RATING_CRIADO, 1),
  },
  {
    slug: 'participante-ativo',
    trigger: DomainEventName.COMENTARIO_CRIADO,
    titulo: 'Participante Ativo',
    descricao: 'Criou 10 comentários em cursos ou simulações',
    condition: thresholdCondition(DomainEventName.COMENTARIO_CRIADO, 10),
  },
  {
    ...
    condition: thresholdCondition(DomainEventName.MENTORIA_ACEITE, 1),
  },
  {
    ...
    condition: thresholdCondition(DomainEventName.EXPERIENCIA_PUBLICADA, 1),
  },
  {
    slug: 'estudante-curioso',
    trigger: DomainEventName.CURSO_INSCRICAO,
    titulo: 'Estudante Curioso',
    descricao: 'Inscreveu-se em 5 cursos diferentes',
    condition: thresholdCondition(DomainEventName.CURSO_INSCRICAO, 5),
  },
  // Novas regras G15-T6
  {
