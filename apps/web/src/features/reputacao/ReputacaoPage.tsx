    ...
    <div className="mx-auto max-w-6xl space-y-8 pb-20 animate-in fade-in duration-1000">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-text-secondary mt-2 max-w-lg leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-4 gap-4 auto-rows-[200px]">
        ...
        <Card className="md:col-span-3 lg:col-span-2 lg:row-span-2 flex flex-col items-center justify-center bg-surface-alt border-accent/10 relative overflow-hidden group shadow-2xl">
          ...
          >
             ...
             <div className="absolute flex flex-col items-center">
                <span className="text-7xl font-black text-text-primary font-mono tracking-tighter">{score}</span>
          ...
          <div className="mt-8 text-center px-12 z-10">
             <p className="text-xs font-medium text-text-muted leading-relaxed">
               Este índice representa a tua <span className="text-text-primary">Autoridade de Mérito</span>. 
        ...
        <Card className="md:col-span-3 lg:col-span-2 flex flex-col justify-between p-8 bg-surface border-white/5 hover:border-accent/20 transition-all group">
        ...
        <Card className="md:col-span-2 lg:col-span-1 flex flex-col justify-between p-6 bg-surface border-white/5">
           <div className="p-2 w-fit bg-accent/5 rounded-xl text-accent mb-2">
              <TrendingUp size={20} />
           </div>
           <div>
              <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Simulações</p>
        ...
        <Card className="md:col-span-2 lg:col-span-1 flex flex-col justify-between p-6 bg-surface border-white/5">
           ...
           <div>
              <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Interacções</p>
              <p className="text-3xl font-black font-mono">{dimensions.engagement}</p>
              <p className="text-[9px] text-text-muted mt-1 uppercase font-bold">Votos e Comentários</p>
           </div>
        </Card>
        ...
        <Card className="md:col-span-2 lg:col-span-1 flex flex-col justify-between p-6 bg-surface border-white/5">
           ...
           <div>
              <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Antiguidade</p>
              <p className="text-3xl font-black font-mono">{dimensions.tempoPlataforma}</p>
              <p className="text-[9px] text-text-muted mt-1 uppercase font-bold">Meses na Trajectória</p>
           </div>
        </Card>

        {/* Card Breakdown Detalhado (The Matrix) */}
        <Card className="md:col-span-6 lg:col-span-2 lg:row-span-1 p-8 bg-surface-alt border-white/5 relative overflow-hidden">
              ...
              {[
                ...
                <div key={d.label} className="space-y-1.5">
                   <div className="flex justify-between text-[9px] font-bold uppercase tracking-widest">
                      ...
                      <span className="text-text-primary font-mono">{Math.round(d.val)}%</span>
                   </div>
