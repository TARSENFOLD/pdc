...
nter text-accent group-hover:scale-110 transition-transform">
            ...
            <div className="aspect-square rounded-2xl bg-white/5 border border-dashed border-white/10 flex items-center justify-center text-ink-tertiary text-[10px] font-bold">
              +8
            </div>
          </div>
          <Button variant="ghost" className="w-full text-xs font-bold text-ink-tertiary hover:text-ink-primary">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1,2].map(i => (
            <Card key={i} className="group overflow-hidden rounded-[28px] bg-recessed border border-white/5 hover:border-accent/30 transition-all">
              ...
              <div className="p-6 space-y-4">
                <h4 className="font-bold text-ink-primary group-hover:text-accent transition-colors">Diagnóstico de Redes Angolanas</h4>
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <span className="text-[10px] text-ink-tertiary font-bold uppercase tracking-tighter">Validado por 2 Mentores</span>
                </div>
              </div>
            </Card>
          ))}
