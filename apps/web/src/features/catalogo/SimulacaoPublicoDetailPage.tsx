...
export function SimulacaoPublicoDetailPage() {
  ...
  if (isError || !sim) return <div className="flex min-h-screen items-center justify-center bg-canvas p-4"><EmptyState icon={Search} title="Simulação não encontrada" description="Não foi possível carregar os dados desta simulação." /></div>;
