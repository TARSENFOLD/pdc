    ...
    <div className="mx-auto max-w-6xl space-y-10 pb-20 animate-in fade-in duration-1000">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-2">
           <Button variant="secondary" size="md" className="bg-recessed border-white/5 font-bold text-[10px] uppercase tracking-widest px-4">
            ...
            return (
              ...
              >
                <Link to={`${config.href}/${bookmark.targetId}`}>
                  <Card className="group relative p-6 h-full bg-recessed border-white/5 hover:border-accent/30 transition-all shadow-xl flex flex-col justify-between overflow-hidden">
                    ...
                    <div>
                       <div className="flex justify-between items-start mb-6">
                          ...
                          <Badge className="bg-white/5 text-ink-tertiary border-white/5 text-[8px] font-black uppercase tracking-widest">{config.label}</Badge>
                       </div>
                       <h3 className="text-lg font-bold text-ink-primary tracking-tight group-hover:text-accent transition-colors">
                         {bookmark.targetId}
                       </h3>
                    </div>
                    <div className="mt-8 pt-4 border-t border-white/5 flex items-center justify-between">
                       ...
                       <ArrowRight size={14} className="text-ink-tertiary group-hover:translate-x-1 transition-transform" />
                    </div>
                  </Card>
                </Link>
              </motion.div>
