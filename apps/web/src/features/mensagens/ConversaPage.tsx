...
export function ConversaPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-120px)] gap-4 animate-in fade-in duration-700">
      <div className="flex-1 flex flex-col bg-canvas border border-white/5 rounded-[32px] overflow-hidden shadow-2xl">
        <header className="p-6 border-b border-white/5 bg-white/[0.01] flex items-center justify-between">
           <div className="flex items-center gap-4">
              ...
              <div>
                 <h2 className="text-sm font-black text-ink-primary uppercase tracking-widest">Canal de Mentoria</h2>
                  ...
                  <div className="max-w-[70%] space-y-1">
                     <div className={`px-5 py-3.5 rounded-[22px] text-sm leading-relaxed ${
                       msg.remetenteId === user?.id 
                        ...
                        : 'bg-recessed border border-white/5 text-ink-primary rounded-tl-none'
                     }`}>
                        {msg.conteudo}
                     </div>
                     <span className="text-[9px] font-mono text-ink-tertiary uppercase px-2 block text-right">
        ...
        <footer className="p-6 bg-white/[0.01] border-t border-white/5">
           <div className="flex items-center gap-4 bg-recessed border border-white/5 rounded-2xl p-2 px-4 focus-within:border-accent/40 transition-all">
              <textarea
                value={novoConteudo}
      ...
      <aside className="hidden lg:block w-80 space-y-4">
         <Card className="p-8 bg-recessed border-white/5 rounded-[32px] space-y-8">
            <div className="text-center space-y-4">
               <Avatar src="" fallback="C" className="h-24 w-24 mx-auto border-4 border-accent/20" />
               <h3 className="text-xl font-bold text-ink-primary tracking-tight">Interlocutor</h3>
            </div>
            <div className="pt-6 border-t border-white/5">
               <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-ink-tertiary flex items-center gap-2 mb-4">
