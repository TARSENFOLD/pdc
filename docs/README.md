...
3. [🔐 Mapeamento de Secrets](operations/secrets-mapping.md) — destino por service e rotação.
4. [📱 Mobile Native Release](guia-tecnico/deploy.md#2-android-twa-pwabuilder) — Capacitor e TWA pipeline.

### 🤝 Contribuidores Externos

1. [📜 Código de Conduta](../CONTRIBUTING.md) — Valores e governação.
2. [🎨 Design System Soul & Elite](https://github.com/pordentrodo-coder/pdc/blob/main/specs/IMPORTANTE/05_%E2%80%94_Design_System_Soul_&_Elite_%28Tokens,_Primitivos_e_Wireframes%29.md) — Bíblia visual.
...
- [🔐 Mapeamento de Secrets](operations/secrets-mapping.md)
...
_Última auditoria de governação: 30 de Abril de 2026._
