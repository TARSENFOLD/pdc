...
export const NavItems: Record<NavItemSlug, NavItemLabel> = {
  ...
  catalogo_cursos: { 'pt-PT': 'Catálogo de cursos', 'pt-BR': 'Catálogo de cursos', en: 'Course catalog' },
  ...
  estudantes_vinculados: { 'pt-PT': 'Estudantes Vinculados', 'pt-BR': 'Estudantes Vinculados', en: 'Linked Students' },
  propostas: { 'pt-PT': 'Propostas', 'pt-BR': 'Propostas', en: 'Proposals' },
  relatorios: { 'pt-PT': 'Relatórios', 'pt-BR': 'Relatórios', en: 'Reports' },
  branding: { 'pt-PT': 'Identidade Visual', 'pt-BR': 'Identidade Visual', en: 'Branding' },
